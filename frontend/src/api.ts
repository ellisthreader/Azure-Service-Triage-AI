...
export const SYNTHETIC_STAFF: Record<string, StaffMember> = {
  ...
  daniel: {
    ...
    role: "Waste and Environment Coordinator",
    team: "Environment and climate action",
    avatar_url: "/staff/tom-bennett.png",
    service_area: "Waste and environment",
    decision_focus: "Assess waste, recycling centre and environmental reports for operational follow-up.",
  ...
  nina: {
    ...
    avatar_url: "/staff/rachel-hughes.png",
    service_area: "Children and families",
    decision_focus: "Review family support, early help and safeguarding signals before deciding next action.",
    default_service_type: "children_services",
    default_information_type: "teams_referral",
  },
  owen: {
