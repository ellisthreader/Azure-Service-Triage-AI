...
export type StaffMember = {
  ...
  default_information_type?: string;
};
...
export const SYNTHETIC_STAFF: Record<string, StaffMember> = {
  me: {
    ...
    team: "Customer Services Centre",
    avatar_url: "/staff/demo-officer-profile.png",
    service_area: "Customer services",
    decision_focus: "Triage resident contact, check missing details, and route to the right service team.",
    default_information_type: "resident_report",
  },
  alice: {
    id: "staff-alice",
    name: "Alice Morgan",
    ...
    team: "Essex contact centre",
    avatar_url: "/staff/alice-morgan.png",
    service_area: "Resident contact",
    decision_focus: "Handle phone, email and web reports, capture the issue clearly, and escalate urgent contact.",
    default_information_type: "resident_report",
  },
  samir: {
    id: "staff-samir",
    ...
    role: "Adult Social Care Duty Manager",
    team: "Adult social care",
    avatar_url: "/staff/samir-khan.png",
    service_area: "Adult social care",
    decision_focus: "Review safeguarding, vulnerability and care urgency before assigning duty action.",
    default_service_type: "adult_social_care",
    default_information_type: "teams_referral",
  },
  tom: {
    id: "staff-tom",
    name: "Tom Bennett",
    username: "tom.bennett@essex.example",
    role: "Highways Customer Liaison Officer",
    team: "Highways service",
    avatar_url: "/staff/tom-bennett.png",
    service_area: "Highways",
    decision_focus: "Review road, pavement, drainage and street-lighting reports for public-safety priority.",
    default_service_type: "highways",
    default_information_type: "resident_report",
  },
  rachel: {
    id: "staff-rachel",
    ...
    role: "SEND Casework Officer",
    team: "Children, families and education",
    avatar_url: "/staff/rachel-hughes.png",
    service_area: "SEND and education",
    decision_focus: "Check education, family support and statutory-deadline context before recommending priority.",
    default_service_type: "children_services",
    default_information_type: "case_portal",
  },
  maya: {
    id: "staff-maya",
    name: "Maya Patel",
    ...
    team: "Adult social care finance",
    avatar_url: "/staff/alice-morgan.png",
    service_area: "Financial assessment",
    decision_focus: "Review hardship, charging, assessment and support evidence before routing finance cases.",
    default_service_type: "benefits",
    default_information_type: "email_update",
  },
  daniel: {
    id: "staff-daniel",
    name: "Daniel Reed",
    username: "daniel.reed@essex.example",
    role: "Waste Disposal Operations Officer",
    team: "Recycling centres and waste disposal",
    avatar_url: "/staff/tom-bennett.png",
    service_area: "Waste disposal and recycling centres",
    decision_focus: "Assess recycling-centre, waste disposal and environmental service reports for operational follow-up.",
    default_service_type: "waste",
    default_information_type: "inspection_note",
  },
  nina: {
    id: "staff-nina",
    name: "Nina Scott",
    username: "nina.scott@essex.example",
    role: "Children and Families Hub Advisor",
    team: "Children and Families Hub",
    avatar_url: "/staff/rachel-hughes.png",
    service_area: "Children and families intake",
    decision_focus: "Receive concerns and requests, gather safe information, and route families to the right support.",
    default_service_type: "children_services",
    default_information_type: "teams_referral",
  },
  owen: {
    ...
    role: "Locality Partnership Officer",
    team: "District and borough partnerships",
    avatar_url: "/staff/samir-khan.png",
    service_area: "Locality partnerships",
    decision_focus: "Coordinate district housing, revenues and local-partner cases that need county input.",
    default_service_type: "housing",
    default_information_type: "email_update",
  },
  clara: {
    id: "staff-clara",
    name: "Clara Evans",
    username: "clara.evans@essex.example",
    role: "Corporate Complaints Officer",
    team: "Customer feedback and complaints",
    avatar_url: "/staff/demo-officer-profile.png",
    service_area: "Complaints",
    decision_focus: "Track complaint stage, statutory response dates, directorate owner and Ombudsman risk.",
    default_information_type: "email_update",
  },
};
